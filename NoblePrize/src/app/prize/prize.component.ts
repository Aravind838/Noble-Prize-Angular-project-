...
export class PrizeComponent implements OnInit {
  ...
  YEAR: any[] = ['', 2018, 2017, 2016, 2015, 2014, 2013, 2012, 2011, 2010, 2009, 2008, 2007, 2006, 2005, 2004, 2003, 2002, 2001, 2000,
               ...
               1959, 1958, 1957, 1956, 1955, 1954, 1953, 1952, 1951, 1950, 1949, 1948, 1947, 1946, 1945, 1944, 1943, 1942, 1941, 1940,
               1939, 1938, 1937, 1936, 1935, 1934, 1933, 1932, 1931, 1930, 1929, 1928, 1927, 1926, 1925, 1924, 1923, 1922, 1921, 1920,
               1919, 1918, 1917, 1916, 1915, 1914, 1913, 1912, 1911, 1910, 1909, 1908, 1907, 1906, 1905, 1904, 1903, 1902, 1901];

  Categories: any[] = ['', 'chemistry', 'economics', 'literature', 'medicine', 'peace', 'physics'];

  ngOnInit() {
    this.nobleservice.getWinners()
        .subscribe
           (
             data => {
                this.Nobleprizes = data.prizes;
